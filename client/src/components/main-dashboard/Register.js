 ...
 <div className="join">
       <Navigation />
            <form className="form-login" onSubmit={handleSubmit}>
              <div className="form-inner reg">
                <div className="form-group">
                  <input type="text" name="user_name" id="username-field" className="input-field" placeholder="Username" onChange={(e) => setUser({ ...user, user_name: e.target.value })} required></input>        
               </div>
               <div className="form-group">
                 <label htmlFor="email">Email:</label>
                <input type="email" name="email" id="usermail-field"  className="input-field" placeholder="Email"   onChange={(e) => setUser({ ...user, email: e.target.value })} required></input> 
                </div>
              <div className="form-group">
                  <label htmlFor="password">Password:</label>
                    <input type="password" name="password" id="password-field"  className="input-field" placeholder="Set Password"  onChange={(e) => setUser({ ...user, password_confirmation: e.target.value })}required></input> 
                </div>
                <div className="form-group">
                   <label htmlFor="confirm-password">Confirm Password:</label>            
                   <input type="password" name="confirm-password" id="password-field2" className="input-field" placeholder="Confirm Password"      onChange={(e) => setUser({ ...user, password: e.target.value })} required></input> 
                </div>
