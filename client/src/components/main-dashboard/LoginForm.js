...
function submitHandler(e){
  ...
  //     //  if ((user.user.body.email === "admin@bookameal.com") && (user.user.body.user_type === "admin")){
  //     //   navigate("/admin")
  //     //  }
  //     //  else{
  //     //   navigate("/UserHome")
  ...
  //     // user.user.body.email !== "admin@bookameal.com" && user.user.body.user_type !== "admin" ? navigate("/UserHome") : navigate("/admin ");
  //     // navigate('/UserHome')
